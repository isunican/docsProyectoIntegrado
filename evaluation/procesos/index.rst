...
Estas dos actividades se realizarán para todas las historias de usuario implementadas y se evaluarán según los siguientes pesos ponderados ``P`` 50% y ``E`` 50%. 
...
* La codificación y ejecución de dos pruebas unitarias.
* La codificación y ejecución de una prueba de interfaz de usuario.
...
Cada Historia de Usuario ha de contar con un Plan de Pruebas, que incluirá:
 ...
 #. La especificación de las pruebas de integración.
