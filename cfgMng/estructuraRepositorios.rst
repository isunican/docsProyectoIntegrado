...
Ambos modelos se almacenarán como imágenes en formato ``.png``. El fichero correspondiente a las clases del modelo deberá llamarse ``ModelEntities.png``, mientras que el modelo arquitectónico tendrá como nombre ``AppArchitecture.png``.
